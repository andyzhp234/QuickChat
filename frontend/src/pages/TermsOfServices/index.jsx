...
export default function TermsOfServices() {
  return (
    <div className="px-20 py-10">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Quick Chat.
          </p>
        </li>
        <li>
          <p>
      ...
      <h1 className="py-2 text-4xl font-semibold">Acknowledgment</h1>
      <p>
      ...
      <h1 className="py-2 text-4xl font-semibold">Links to Other Websites</h1>
      <p>
      ...
      <h1 className="py-2 text-4xl font-semibold">Limitation of Liability</h1>
      <p>
      ...
      <h1 className="py-2 text-4xl font-semibold">Governing Law</h1>
      <p>
      ...
      <h1 className="py-2 text-4xl font-semibold">Disputes Resolution</h1>
      <p>
      ...
      <h1 className="py-2 text-4xl font-semibold">Severability and Waiver</h1>
